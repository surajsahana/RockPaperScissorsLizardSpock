...
// Reset our score & player choice/computer choice
function resetAll() {
	playerScoreNumber = 0;
...
function updateScore(playerChoice) {
	if(playerChoice === computerChoice) {
		...
		if(choice.defeats.indexOf(computerChoice) > -1) {
			startConfetti();
			resultText.textContent = "You Won! ✌️";
			playerScoreNumber++;
			playerScoreEl.textContent = playerScoreNumber;
		} else {
...
// This is our confetti - downloaded from https://www.cssscript.com/confetti-falling-animation/
